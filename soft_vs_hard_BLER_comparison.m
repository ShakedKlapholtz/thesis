...
for SNR = 1:length(SNR_dB_range)
    ...
    try
        ...
        filename1 = sprintf('EbN0_3.0_dB_AWGN.mat', EbN0);
        filename2 = sprintf('EbN0_%0.1f_dB_BSC.mat', EbN0);
        data1 = load(filename1);
        data2 = load(filename2);
    end
